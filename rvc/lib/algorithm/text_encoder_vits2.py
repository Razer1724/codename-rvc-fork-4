...
from rvc.lib.algorithm.transformer_encoder_vits2 import TransformerEncoderVITS2


class TextEncoderVITS2(nn.Module):
    """
    Text Encoder.
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(TextEncoderVITS2, self).__init__()
        ...
        self.encoder = TransformerEncoderVITS2(
            hidden_channels,
            filter_channels,
            n_heads,
            n_layers,
